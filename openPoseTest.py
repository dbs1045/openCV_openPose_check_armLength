...
에서 Pose에 openPose 관절 dataset을 구할수 있습니다.
"""
def output_keypoints(frame, proto_file, weights_file, threshold, model_name, BODY_PARTS):
    ...
    """The first dimension 각 키포인트 마다의 신체부위의 confidence map을 나타냄"""
    ...
    lenArm = math.sqrt((points[2][0]-points[3][0])**2+(points[2][1]-points[3][1])**2)+math.sqrt((points[3][0]-points[4][0])**2+(points[3][1]-points[4][1])**2)
    print (f"팔길이: {lenArm}")
...
protoFile_mpi = "./mpi/pose_deploy_linevec.prototxt"
protoFile_mpi_faster = "./mpi/pose_deploy_linevec_faster_4_stages.prototxt"
protoFile_coco = "./coco/pose_deploy_linevec.prototxt"
protoFile_body_25 = "./body25/pose_deploy.prototxt"

# 훈련된 모델의 weight 를 저장하는 caffemodel 파일
weightsFile_mpi = "./mpi/pose_iter_160000.caffemodel"
